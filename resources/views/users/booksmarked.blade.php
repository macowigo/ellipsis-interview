    ...
    <div class="row">
        <div class="col s12">
          <div class="card material-table">
            ...
            <h6 class="maroon-text centered-text" ><i class="material-icons">bookmark_add</i> 
              Books Marked: {{number_format($markedcount)}}</h6>
            ...
            @if ($message = Session::get('succes'))
             ...
             @endif
              ...
              @endif
              @if ($marked->isempty())
              <span class="materialize-red-text">Sorry currently there is no any book marked</span>
              @else
         ...
         <table id="datatable" class="responsive-table">
            ...
            <tr>
              ...
              <td>
                ...
                <form action="{{route('unbookmark',$bookslist->bookid)}}" method="POST">
                    @csrf
                     @method('POST')
                      <td>
                      <button type="submit" class="btn-floating maroon btn-small" title="Click to Unmark Book">
