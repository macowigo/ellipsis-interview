    ...
    <div class="row">
        <div class="col s12">
          <div class="card material-table">
            ...
            <h6 class="maroon-text centered-text" ><i class="material-icons">thumb_up</i> 
              Liked Books: {{number_format($likescount)}}</h6>
            ...
            @if ($message = Session::get('succes'))
             ...
             @endif
              ...
              @endif
              @if ($liked->isempty())
              <span class="materialize-red-text">Sorry currently there is no any book you like</span>
              @else
