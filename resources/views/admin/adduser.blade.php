    ...
    <div class="row">
        <div class="col s12">
          <div class="card card-login">
            ...
            <h6 class="maroon-text centered-text" ><i class="material-icons">person_add</i> Add System User</h6>
            ...
            @if ($message = Session::get('succes'))
             ...
             @endif
              ...
              @endif
               <form method="POST" enctype="multipart/form-data" action="{{route('addcustomer')}}">
                @csrf
               <div class="input-field col l6 m11 s12">
                ...
                <i class="material-icons prefix">account_circle</i>
                    ...
                    <input id="contact" type="text" name="contact"  class="validate" maxlength="10" pattern="[0]{1}[1-9]{1}[0-9]{8}" required>
                ...
                <div  class="col s12" >
                <button class="btn right hoverable maroon" type="submit" name="adduser">ADD</button>
                </div>
               </form>
            </div>
          </div>
