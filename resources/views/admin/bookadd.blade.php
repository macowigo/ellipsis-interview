...
<head>
    ...
    <title>ElipsissIntreview-AddBook</title>
          ...
          <div class="card card-login">
            ...
            @if ($message = Session::get('succes'))
             ...
             @endif
              ...
              @endif
               <form method="POST" enctype="multipart/form-data" action="{{route('adminaddbook')}}">
                @csrf
               {{-- <div class="input-field col s12">
                <i class="material-icons prefix">library_books</i>
                    <input id="booktitle" name="booktitle" type="text" class="validate" minlength="3" required>
                ...
                <div class="col s12 file-field input-field">
                    <div class="btn blue">
                        ...
                        <input type="file"  name="book" id="fileSelect" class="validate" required>
                    </div>
                ...
                <div  class="col s12" >
                <button class="btn right hoverable maroon" type="submit">ADD</button>
                </div>
               </form>
            </div>
          </div>
