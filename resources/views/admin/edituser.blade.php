...
<head>
    ...
    <title>Elipsiss-Intreview</title>
...
<div class="preloader-wrapper big active loader" id="loading">
      ...
      <div class="spinner-layer spinner-green">
        ...
        <div class="container-card page" style="display: none;">
    <div class="row">
        <div class="col s12">
          <div class="card card-login">
            <div class="card-content" >
            <h6 class="maroon-text centered-text" ><i class="material-icons">edit</i> Edit System User</h6>
            ...
            @if ($message = Session::get('succes'))
             ...
             @endif
              ...
              @endforeach
               <form method="POST" enctype="multipart/form-data" action="{{route('updateuser',$details->id)}}">
                @csrf
               
               <div class="input-field col l6 m11 s12">
                <i class="material-icons prefix">account_circle</i>
                    <input id="firstname" name="firstname" type="text"
                    value="{{$details->first_name}}" class="validate" minlength="3" required>
                ...
                <i class="material-icons prefix">account_circle</i>
                    ...
                    value="{{$details->last_name}}" minlength="3" required>
                    ...
                    value="{{$details->contact}}" maxlength="10" pattern="[0]{1}[1-9]{1}[0-9]{8}" required>
                ...
                <div  class="col s12" >
                <button class="btn right hoverable maroon" type="submit">EDIT</button>
                </div>
               </form>
            </div>
          </div>
