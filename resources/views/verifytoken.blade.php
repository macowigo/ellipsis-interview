        ...
        <div class="row">
            <div class="col s12 ">
                <div class="card card-login">
                    ...
                    <span class="card-title">Enter Token sent in your Email/Phone Contact</span>
                        ...
                        @csrf
                            <div class="step-content">
                                <div class="row">
                                   ...
                                   <button class="btn right maroon" type="submit" formaction="{{route('tokenverification',Auth::user()->email)}}">Verify</button>
