...
! function(t) {
    ...
    function S(t) {
        ...
        return v.reset = function() {
            ...
            var t = q.indexOf(v);
            t > -1 && q.splice(t, 1), v.paused = !0
        }, v.play = function() {
            v.paused && (v.paused = !1, h = 0, d = n(v.currentTime), q.push(v), N || z())
        }, v.reverse = function() {
    ...
    var I = {
        ...
        z = function() {
            ...
            function e(e) {
                var i = q.length;
                if (i) {
                    for (var n = 0; i > n;) q[n] && q[n].tick(e), n++;
                    t()
    ...
    return S.version = "2.2.0", S.speed = 1, S.running = q, S.remove = function(t) {
        ...
        for (var e = q.length; e--;)
            for (var i = q[e], n = i.animations, o = n.length; o--;) s(t, n[o].animatable.target) && (n.splice(o, 1), n.length || i.pause())
